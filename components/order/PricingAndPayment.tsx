...
// export default function PricingAndPayment({ data, setData, setAlertConfig, readOnly }: PricingAndPaymentProps) {
...
//           className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-300"
//           disabled={readOnly || isAgreementConfirmed}
//         >
...
//           </p>
//         )}
//         {!readOnly && data.paymentStatus !== 'paid' && (
//           <button
